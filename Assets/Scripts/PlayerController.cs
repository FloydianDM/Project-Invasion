...
public class PlayerController : MonoBehaviour
{
    ...
    void Move()
    {
        float xChange = _movement.x * moveSpeed * Time.deltaTime;
        float yChange = _movement.y * moveSpeed * Time.deltaTime;
    ...
    void Rotate()
    {
        ...
        float movementPitch = _movement.y * pitchMovementFactor;    // amount of pitch related to movement
        float positionalRoll = transform.localPosition.x * rollPositionFactor;  // amount of roll related to local position
        float movementRoll = _movement.x * rollMovementFactor;  // amount of roll related to movement
        float positionalYaw = transform.localPosition.x * yawPositionFactor;    // amount of yaw related to local position
        float movementYaw = _movement.x * yawMovementFactor;    // amount of yaw related to movement
